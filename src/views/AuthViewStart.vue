<template>
<div>
  <svg class="vector" width="100vw" height="340" viewBox="0 0 100vw 340" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <RegistrationForm v-if="isLogged" @toggleForm="toggleForm"/>
