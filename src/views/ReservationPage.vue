<template>
  <div my-auto>
    <v-row class="mx-0 my-12 " justify="center">
      <v-hover>
        <template v-slot:default="{ hover }">
          <v-btn :elevation="hover ? 24 : 6" class="mx-auto pa-6 title text-center" width="300" to="/reservation/create">
    ...
    <v-row class="mx-0 my-12 " justify="center">
      <v-hover>
        <template v-slot:default="{ hover }">
          <v-btn :elevation="hover ? 24 : 6" class="mx-auto pa-6 title text-center" width="300" to="/reservation/search">
            <v-icon width="25" height="25" viewBox="0 0 80 80" color="rgb(103, 80, 164)">
              mdi-calendar-search
            </v-icon>
            <v-col cols="6-sm-2">
    ...
    <v-row class="mx-0 my-12 " justify="center">
      <v-hover>
        <template v-slot:default="{ hover }">
          <v-btn :elevation="hover ? 24 : 6" class="mx-auto pa-6 title text-center" width="300" to="/reservation/send">
            <v-icon width="25" height="25" viewBox="0 0 80 80" color="rgb(103, 80, 164)">
